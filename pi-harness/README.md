...
![pi-harness terminal demo](docs/demo/pi-harness.gif)
...
This writes `docs/demo/pi-harness.gif` and `docs/demo/pi-harness.webm`. The
recording runs the real Pi TUI with a deterministic local provider inside a
networkless Bubblewrap sandbox; it cannot read your home directory, Pi
configuration, sessions, or credentials. See
[`docs/demo/README.md`](docs/demo/README.md) for details.
