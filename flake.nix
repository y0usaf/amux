    ...
    in {
      packages = forAllSystems (pkgs: {
        pi-harness = pkgs.callPackage ./nix/build.nix {
          crane = crane.mkLib pkgs; inherit cordis-rs;
          root = ./pi-harness; pname = "pi-harness";
          cargoPackage = "pi-harness-tui"; binaryName = "pi-harness";
        };
        omp-harness = pkgs.callPackage ./nix/build.nix {
          crane = crane.mkLib pkgs; inherit cordis-rs;
          root = ./omp-harness; pname = "omp-harness";
          cargoPackage = "omp-harness-tui"; binaryName = "omp-harness";
        };
